      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-4xl font-bold text-foreground mb-4">Acesso Restrito</h2>
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Para acessar a biblioteca completa de cantadas cristãs, você precisa estar logado. Faça login ou crie sua
              conta para começar!
            </p>
